...
public class DeclarationResDto extends BaseDeclaration{
    ...
    //证件信息
    private BaseCustomerCredentials customerCredentials;
    //资产证明
    ...
    public BaseCustomerCredentials getCustomerCredentials() {
        return customerCredentials;
    }

    public void setCustomerCredentials(BaseCustomerCredentials customerCredentials) {
