...
public class ArticlePageResDto {
    ...
    public void setCreateDate(String createDate) {
        this.createDate = DateUtils.formatExactMinute(createDate);
    }
    ...
    public void setOperateTime(String operateTime) {
        this.operateTime = DateUtils.formatExactMinute(operateTime);
    }
    ...
    public void setPublishDate(String publishDate) {
        this.publishDate = DateUtils.formatExactMinute(publishDate);
    }
