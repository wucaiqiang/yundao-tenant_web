...
public class CustomerDistributionController {
    ...
    public Result<PermissionResultDto> doAllotToFp(@ModelAttribute CustomerAllotReqDto dto)
        ...
        return HttpUtils.post(TenantUrl.CUSTOMER_DISTRIBUTION_ALLOT_TO_FP, ArgsUtils.toMap(dto), new
    ...
    public Result<PermissionResultDto> doRecycle(@ModelAttribute CustomerMultiIdReqDto dto)
            throws BaseException {
        return HttpUtils.post(TenantUrl.CUSTOMER_DISTRIBUTION_RECYCLE, ArgsUtils.toMap(dto), new
                BaseTypeReference<Result<PermissionResultDto>>() {
                });
    }
    ...
    public Result<Boolean> doAllotToCs(@ModelAttribute CustomerAllotToCsReqDto dto)
            throws BaseException {
        return HttpUtils.post(TenantUrl.CUSTOMER_DISTRIBUTION_ALLOT_TO_CS, ArgsUtils.toMap(dto), new
