...
public class CustomerImportV2Controller {
    ...
    public Result<Object> importCustomerV2(@RequestParam(value = "file") MultipartFile file, HttpServletResponse response) throws Exception {
        return customerImportService.importFromCustomer(response, file);
    }
